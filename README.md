...
| Propiedades ↓/Plataformas → | Amazon EC2 | Microsoft Azure | IBM Smartcloud |
|-----------------------------|------------|-----------------|----------------|
| auto-scaling | Sí | Sí | Sí |
| Blueprints | Sí | Sí | Sí |
| Soporte para Windows | Sí | Sí | Sí |
| Soporte para Linux | Sí | Sí | Sí |
| Lenguajes soportados |  | C++, C#, Java, Perl, Python, Ruby | .net, Java, Node.js, Python | Java, PHP |
| Soporte de almacenamiento de datos | Sí | Sí | Sí |
| Soporte de colas | Sí | Sí | Sí |
| Servidor web | Sí | Sí | Sí |
| Alternativas de hipervisor | Sí | Sí | Sí |
| Soporte de DataGrid | Sí | Sí | Sí |
| Soporte para Big Data | Sí | Sí | Sí |
